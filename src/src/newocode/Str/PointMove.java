...
public class PointMove {
    public static void main(String[] args) {
        ...
        for (String point : points) {
            ...
            char ch = point.toUpperCase().charAt(0);

            if (ch == 'A') {
                try {
                    int leftN = Integer.valueOf(point.substring(1, point.length()));
                    a -= leftN;
                } catch (Exception e) {
                    continue;
                }
            ...
            if (ch == 'D') {
                try {
                    int rightA = Integer.valueOf(point.substring(1, point.length()));
                    a += rightA;
                } catch (Exception e) {
                    continue;
                }
            ...
            if (ch == 'W') {
                try {
                    int upA = Integer.valueOf(point.substring(1, point.length()));
                    b += upA;
                } catch (Exception e) {
                    continue;
                }
            ...
            if (ch == 'S') {
                try {
                    int downN = Integer.valueOf(point.substring(1, point.length()));
                    b -= downN;
                } catch (Exception e) {
                    continue;
                }
